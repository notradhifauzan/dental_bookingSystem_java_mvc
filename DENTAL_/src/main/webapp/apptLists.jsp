				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav me-auto mb-2 mb-md-0">
						...
						<li class="nav-item active"><a class="nav-link active"
							aria-current="page" href="Staffs?action=appointments">Appointments</a></li>
							<li class="nav-item"><a class="nav-link"
						...
						<td><c:choose>
								<c:when test="${booking.progress == 'pending'}">
									<button data-bs-toggle="modal"
										...
										class=" btn btn-sm btn-outline-danger btn-action">cancel</button>
									<br>
									<button data-bs-toggle="modal"
										data-bs-target="#confirm<c:out value='${booking.id}' />"
										class="btn btn-sm btn-outline-info btn-action">confirm</button>
								</c:when>
								<c:when test="${booking.progress == 'confirmed'}">
									<c:if test="${booking.staffid == staff.id }">
										<button data-bs-toggle="modal"
											data-bs-target="#complete<c:out value='${booking.id}' />"
											class="btn btn-sm btn-outline-success btn-action">complete</button>
									</c:if>
								</c:when>
							</c:choose></td>
					</tr>
